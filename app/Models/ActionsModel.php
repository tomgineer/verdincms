...
/**
 * Returns an array of available system actions with metadata.
 *
 * Each action includes a title, internal action key, and associated icon.
 * Used to render actionable items in the system dashboard or admin panel.
 *
 * @return array  List of system action definitions
 */
public function getActionsArray() {
    $actions = [
        ...
        [
            'title'  => 'Photos to Placeholders',
            'action' => 'photosToPlaceholders',
            'icon'   => 'wallpaper'
        ],
        [
            'title'  => 'Reset Trending',
            'action' => 'resetTrending',
            'icon'   => 'chart-data'
        ],
        [
            'title'  => 'Purge Cron Log',
            'action' => 'emptyCronLog',
            'icon'   => 'mop'
        ],
        [
            'title'  => 'Purge Error Logs',
            'action' => 'clearErrorLogFiles',
            'icon'   => 'mop'
        ],
        [
            'title'  => 'Purge Cache',
        ...
        [
            'title'  => 'Purge Old Session Files',
            'action' => 'clearSessionFiles',
            'icon'   => 'mop'
        ],
        [
            'title'  => 'Purge Orphan Block Images',
            'action' => 'removeOrphanBlockImages',
            'icon'   => 'mop'
        ],
        [
            'title'  => 'Purge Orphan Avatars',
            'action' => 'removeOrphanAvatars',
            'icon'   => 'mop'
        ],
        [
            'title'  => 'Update Topics Post Count',
            'action' => 'updateTopicsPostCount',
            'icon'   => 'update'
        ],
        [
            'title'  => 'Update Popular Content',
            'action' => 'updatePopularContent',
            'icon'   => 'update'
        ],
        [
            'title'  => 'Optimize Stats Tables',
            'action' => 'optimizeStatsTables',
            'icon'   => 'magic'
        ],
        [
            'title'  => 'Test as Member',
            'action' => 'testMember',
            'icon'   => 'bug'
        ],
        [
            'title'  => 'Test as Writer',
            'action' => 'testWriter',
            'icon'   => 'bug'
        ],
        [
