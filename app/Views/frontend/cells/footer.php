        ...
        <ul class="menu w-full">
            <li>
                ...
                <ul>
                    ...
                    <li><div><?=lang('App.version')?> <?=setting('system.cms')?>: <span class="text-accent"><?= VERDINCMS_VERSION ?></span></div></li>
...
<section class="footer text-base-content border-base-200 border-t-2 px-10 py-8 pb-8 lg:gap-0 bg-base-200" data-theme="<?=setting('theme.darkBlocks')?>">
    ...
    <?php if (empty($socials_list)):?>
        <div class="place-self-center md:justify-self-end">
            <img class="h-15 w-auto opacity-65" src="<?=base_url('gfx/').'svg/no_socials.svg'?>" alt="No Social Media" loading="lazy">
        </div>
    <?php else:?>
