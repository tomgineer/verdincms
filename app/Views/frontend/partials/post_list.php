            ...
            <li class="mb-12">
                ...
                <div class="card lg:card-side rounded-none">
                    <figure class="w-full lg:w-1/3 my-1">
                        <a class="block w-full rounded-[25%_0_25%_0]" href="<?= site_url('post/' . esc($post['id'])) ?>">
                            <img
                                class="rounded-[25%_0_25%_0] lg:shadow-sm w-full aspect-square active:brightness-75 hover:scale-95 hover:brightness-110 hover:shadow-xl hover:transition-all hover:duration-300 hover:ease-in-out"
                    ...
                    <div class="card-body w-full lg:w-2/3 px-0 md:px-6">
                        ...
                        <a class="mb-2 link link-hover active:underline focus:underline" href="<?= site_url('post/' . esc($post['id'])) ?>">
                        ...
                        <div class="card-actions justify-end items-center">
                            ...
                            <?php if (setting('theme.showViewCount')): ?>
                                <span class="badge badge-sm badge-dash badge-info"><?= esc($post['hits']) ?> Views</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
