                ...
                <div class="card lg:card-side rounded-none">
                    <figure class="w-full lg:w-1/3 my-1">
                        <a class="w-full" href="<?= site_url('post/' . esc($post['id'])) ?>">
                            <img
                                class="rounded-xl lg:rounded-[25%_0_25%_0] lg:shadow-sm w-full aspect-video lg:aspect-square object-cover hover:scale-95 hover:brightness-110 hover:shadow-xl hover:transition-all hover:duration-300 hover:ease-in-out"
