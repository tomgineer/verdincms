                ...
                <details>
                    ...
                    <ul class="bg-base-200 rounded-t-none p-2 min-w-52 shadow-xl">
                        <?php if (tier() >= 10): ?>
                            ...
                            <li>
                                <a href="<?= site_url('admin/dashboard/subjects/subjects') ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-info">
                            ...
                            <li>
                                <a href="<?= site_url('admin/dashboard/trash/trash') ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-info">
                            ...
                            <li>
                                <a href="<?= site_url('admin/dashboard/accounts/accounts') ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-info">
                            ...
                            <li>
                                <a href="<?= site_url('admin/dashboard/logs/logs') ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-info">
