            ...
            <?php foreach ($blocks as $group => $items): ?>
                <tr class="bg-base-200">
                    <th colspan="5" class="text-left">
                        Group: <span class="text-accent"><?= esc(ucwords(str_replace('_', ' ', $group))) ?></span>
                    </th>
                </tr>
                <?php if (!empty($items)): ?>
                    <?php foreach ($items as $block): ?>
                        <tr>
                            ...
                            <td class="text-xs text-base-content/70"><?= esc($block['subtitle'] ?? '') ?></td>
                            <td class="text-right">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-base-content/70">No blocks in this group.</td>
                    </tr>
                <?php endif; ?>
            <?php endforeach; ?>
        </tbody>
