...
<section class="tabs tabs-lg tabs-border">
    ...
    <div class="tab-content border-0 p-8">
        ...
        <?= $this->include('dashboard/pages/info/environment') ?>
    </div>
    ...
    <div class="tab-content border-0 p-8">
        ...
        <?= $this->include('dashboard/pages/info/php_gd') ?>
    </div>
    ...
    <div class="tab-content border-0 p-8">
        ...
        <?= $this->include('dashboard/pages/info/session') ?>
    </div>
    ...
    <div class="tab-content border-0 p-8">
        ...
        <?= $this->include('dashboard/pages/info/theme') ?>
    </div>
</section>