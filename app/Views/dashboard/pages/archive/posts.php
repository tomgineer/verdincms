<nav class="flex justify-end mb-4">
    <button class="btn btn-sm btn-outline btn-error" data-dash-action="removeDeletedPosts" data-dash-return="archive/archive">
        ...
        <tbody>
            <?php foreach ($posts as $post): ?>
                <tr>
                    ...
                    <td>
                        <span class="badge badge-dash <?= ($post['f_status'] === 'Draft' ? 'badge-warning' : 'badge-error') ?>">
                            <?= esc($post['f_status']) ?>
                        </span>
                    </td>
